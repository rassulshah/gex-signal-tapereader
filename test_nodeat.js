...
(function(){
  // ⚠⚠ (v15.09) THE ROWS ARE NOW COLUMNS. The old assertions checked one table with rows of equal
...
// (v15.09) the strip is superseded by ROW 3 — he asked for "a thrid row for the HL fields". Both
...
// ---- (v15.09) SLvl / TLvl: no IB, two on the face, the rest on the E row --------------------
(function(){
...
// ---- (v15.09) HIS SKETCH: narrow bar, annotations stacked ABOVE and BELOW, money in the body ---
...
(function(){
  ...
  // ⚠⚠ (v15.09) ASYMMETRIC, like the deflection geometry. v14.99 used ONE symmetric tolerance,
  ...
  // (v15.09) the four levels that did not exist before
...
// ---- (v15.09) THE KING AT A MOMENT, NOT THE KING NOW ------------------------------------------
