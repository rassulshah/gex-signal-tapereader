...
ok('8e rules.json seeds ledger.touch (60 ids)', (function(){ var RJ=JSON.parse(fs.readFileSync('./learning/rules.json','utf8')); return !!RJ.rules['ledger.touch'] && Object.keys(RJ.rules).length===60; })());
