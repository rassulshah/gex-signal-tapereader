@echo off
REM ===========================================================================
REM  compile-gammaprofile.bat  --  DOUBLE-CLICK THIS to rebuild the lsGammaProfile plugin.
REM  Finds Visual Studio, loads the x64 compiler, then calls build-gammaprofile.bat.
