@echo off
REM ===========================================================================
REM  build-daystats.bat  --  compile DayStats.cpp -> lsDayStats.dll (x64)
REM  Run from an "x64 Native Tools Command Prompt for VS", or let
REM  compile-daystats.bat set up the compiler and call this for you.
...
goto :ok
:nocl
echo [ERROR] cl.exe is not on PATH. Use compile-daystats.bat, or an x64 Native Tools Command Prompt.
goto :ok
:failed
echo.
