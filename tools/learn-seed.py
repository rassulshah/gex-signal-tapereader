...
FACTORS = [
    ...
    {"id": "liq",    "name": "LIQUIDITY LEVEL",     "what": "a price level that is not gamma within the zone of the tap — PDH · PDL · PDC · ONH · ONL · AHI · ALO (the Asia session 17:00–02:00 CT) · LHI · LLO (London 02:00–08:30 CT) · the prior day's POC · VAH · VAL · WH · WL. Operator, 2026-09-08: 'the liquidity levels and gamma levels may increase the probability of deflection, so you must look at both and track both'"},
]
...
RULES = [
    ...
    {"id": "L6", "rule": "A STACK — two nodes within ~5 ES points, both growing — marks the extreme of the leg more reliably than a single node.",
     "from": ["E001", "E002", "E004", "E005"], "status": "CONFIRMED", "n": 5, "agree": 5, "weak": 0, "refute": 0,
     "note": "E001 Pb (7735 + 7740, $61M + $81M), E002 c1 (7665 + 7670 + 7675 −γ, the session low), E004 c3 (7745 + 7750, $73M + $46M, the session high 5 pts between them). E005 c1 (the +γ pair 7700 / 7705 at the crown, both growing, the 10:18 high between them) and c6 (the +γ stack 7665 / 7670 + SPY 765 under the −γ King — the LOD printed on it)."},
    {"id": "L9", "rule": "THE KING DEFLECTION is the bread-and-butter setup: a tap of the King — SPX, SPY or QQQ King, each its own row — is the base case every other setup is measured against. Track every King tap with its book, its growth into the tap (d15), its sign, and the outcome.",
     "from": ["E001", "E002", "E003", "E004", "E005", "E006"], "status": "PROPOSED", "n": 12, "agree": 12, "weak": 0, "refute": 0,
    ...
    {"id": "L10", "rule": "A −γ KING IS NOT THE FLOOR. Price goes THROUGH a −γ King under it by about one zone — ES 8–15 pts, NQ 16–28 pts on 2026-09-08 — and turns at the +γ node beneath it (or at nothing, then snaps back above the King within the bar). An entry AT the −γ King is early by a zone; the stop belongs beyond the +γ node, not just under the King.",
     "from": ["E005", "E006"], "status": "PROPOSED", "n": 4, "agree": 4, "weak": 0, "refute": 0,
     "note": "E005 c4 (7680 −γ King at ES ~7686: low 7676.75, turn at the +γ 7670 / SPY 765, closed back above the King in the same bar), c6 (the same King, −$188M by then: the LOD 7672.25 at the +γ 7665 / 7670 stack, 12–15 pts under it); E006 c2 (719 −γ King 29566: low 29549.5, +80 in two bars), c4 (718 −γ King 29524: low 29496, the close 29543.5). The mirror of the doctrine's +γ King that holds AT the strike (E001, E005 c1–c3). Born on one day in two markets — PROPOSED, four legs, none refuting; the tap record's `mae` column is what measures it."},
    {"id": "L11", "rule": "A +γ KING CEILING DECAYS BY THE TAP and is over when the King bleeds: three taps with lower highs and rejections that shrink (E005: 7704 → 7701.75 → 7699.50; 13.75 → 8.5 → 12 pts), then the King lost −$100M in 15 minutes and left the strike — and the next move was the flush through the −γ King below. Read the King's $ after the third tap: a bleeding King is a ceiling that is gone.",
     "from": ["E005"], "status": "PROPOSED", "n": 1, "agree": 1, "weak": 0, "refute": 0,
     "note": "E005 c1–c3 as one series (n=1: one ceiling, three taps). Skylit's 80 / 66 / 33 is the same claim in probabilities (F2.1 is registered on it); this is the picture of it in points."},
    {"id": "L12", "rule": "WHEN A LIQUIDITY LEVEL SITS AT A −γ KING, THE LEVEL GETS SWEPT BEFORE THE TURN — the sweep is the tell, not the level. ES: ONL / LLO 7687.50 at the −γ King 7680, swept 10.75 pts (13:48) and again at 14:42; NQ: the PDC 29569 at the −γ King 719, swept 20 pts (11:57); the prior POC 29512 under the −γ King 718, swept 16 pts (14:54). Every one reclaimed within a bar or two. The +γ turns of the day (c1–c3, c6 on ES; NQ c3) had NO liquidity level within 5 pts.",
     "from": ["E005", "E006"], "status": "PROPOSED", "n": 4, "agree": 4, "weak": 0, "refute": 0,
     "note": "His ask 2026-09-08: track both the gamma level and the liquidity level at every deflection — AHI / ALO / LHI / LLO added to the list (the Asia session 17:00–02:00 CT, London 02:00–08:30 CT; the ES courier has the bars, the NQ courier does not yet). One day, two markets, four legs; the tap record's `liq` column is the measurement. F-14 (284 sessions) already says the level's NAME does not matter and the FLUSH does — this is the same finding with the gamma sign on it."},
    {"id": "L7", "rule": "TIME OF DAY IS A CLASS, NOT A RULE: every deflection carries its hour (H1 08:30–09:30 … H7 14:00–15:00; first · midday · last as the roll-up) and the nightly's pattern table reads the held / turn / resume rates by hour (R-3). The taught legs cluster in the first hour and around noon; the sweep corpus's first-30-minutes edge did NOT survive the night's correction (F-23: 21% vs 18%, n=249 — within chance).",
     "from": ["E001", "E002", "E003", "E004", "E005", "E006"], "status": "PROPOSED", "n": 31, "agree": 16, "weak": 15, "refute": 0,
     "note": "His ruling 2026-09-09 on the first-hour turns he had not circled (ES 08:57 high, 09:12 low at the ONL / LLO sweep, 09:31 low, 09:45 low; the NQ LOD 09:11 at the PDL sweep): \"i agree i think you should also tag other hours\" — counted as m1–m4 (E005) and m1 (E006), tagged H1 / H2; every leg tagged. By hour over the 31 legs: H1 7 · H2 5 · H3 3 · H4 5 · H5 5 · H6 3 · H7 3. First hour: E002 c1 09:27, E003 c1 08:42–09:00, E004 c1 08:45–09:10, E005 m1 / m2, E006 c1 / m1. Noon: E001 R2 11:57–12:06, Pb 12:20–12:36, R3 13:12; E002 c3 12:51–13:24; E003 c3 12:06, c4 13:12; E004 c3 12:10; E005 c2 12:06. Withdrawn: 'the first 30 minutes matter (27% vs 18%, n=180)' — that number carried the corpus's look-ahead (F-23)."},
]
...
EXAMPLES = [
    ...
    {
        "id": "E005", "date": "2026-09-08", "chart": "ES1 · Skylit · 3-min · Sep 8 08:30–15:00 CT, the projection on (the PDH 7717.75 · PDC 7681 · PDL 7672.25 lines on the chart are Sep 8's own, drawn for Sep 9). The day: O 7711.50 · H 7717.75 (08:30) · L 7672.25 (14:59) · C 7678.25. The prior session is Fri Sep 4 (Sep 7 Labor Day): PDH 7751 · PDL 7711.75 · PDC 7723.75 · POC 7721.25 · VAH 7730.50 · VAL 7713.25; ONH 7725.75 (23:46) · ONL 7687.50 (03:02) · AHI 7725.75 · ALO 7694.75 (01:20) · LHI 7718.25 (05:20) · LLO 7687.50 (03:02). ES = SPX + 4 (±1.5) today (Skylit's ratio 1.0006–1.0009); SPY × 10.027.", "tz": "CT",
        "img": "learning/deflections/img/E005.png",
        ...
        "his": "here are 6 deflections identified by the circles. each should be counted as 1 deflection. you should analyze the time and price and gamma node with all its details. in the future, you should be able to identify them like i am identifying them, and score them to predict the deflection in advance. see also if there were any type of patterns as well as levels there like ONH ONL, PDH, PDL, Asia High Asia Low, London High and London Lo, prior day poc, vah, val. i was not tracking sweeps of the asia and london highs and low, but we should do it. they can be ALO, AHI, LLO, LHI. you will find that the liquidity levels and gamma levels may increase the probability of deflection, so you must look at both and track both, so you are able to better score and predict a potential deflection will happen and give me a entry or exit target in the future, but first you must get really good at identification of deflections and levels and both as well as patterns like rug, rrug, piku stack, barney stack etc.. only after you put all of this together over time will you start giving me valid predictions. Especially after adding hod lod statistics as well as things like volume. so make sure you track, score over time to get to this level of competence and reach my intended purpose of the project, which you should always keep in mind.",
        "legs": [
            {"leg": "c1", "kind": "PULLBACK", "side": "resistance", "when": "10:12–10:21 CT (three bars in the zone; the high 10:18)", "px": "high ES 7704 at 10:18 → 7690.25 by 11:15 (−13.75 in 19 bars)", "node": "SPXW 7700, THE KING, +γ 100% (ES ~7704) with 7705 +γ 96–100% one strike up (ES ~7709; the crown flapped 7700 ↔ 7705 from 09:51 to 10:18) — a +γ pair at the crown; SPY 768 −45% (ES 7700.7) in the other book",
             "data": "7700: $88M (09:45) → $105M (10:00) → $125M at 10:18, the tap bar — d15 +$18–23M every reading, FRESH, 0 taps; the record's own o10 for 7700 at 10:03 / 10:06 / 10:18: DEFLECT. 7705: $80M → $123M (d15 +$23M) and NOTOUCH — the high stopped 5 pts under it. By 10:21 7700 read TESTED (1 tap), by 10:24 DELIVERED (2). No liquidity level within 5 pts (ALO 7694.75 nine below, VAL 7713.25 nine above). The SMA-50 sat at ~7700 — price rejected from just above it.", "factors": ["king", "growth", "stack", "heavy"]},
            {"leg": "c2", "kind": "PULLBACK", "side": "resistance", "when": "11:57–12:09 CT (the high 12:06)", "px": "high ES 7701.75 at 12:06 → 7693.25 by 12:24 (−8.5 in 6 bars) — the second, lower high under the King", "node": "SPXW 7700, still THE KING, +γ 100% (ES ~7704) — and SPY 768 +54% (rank 2, ES 7700.7): the two books' lines 3 pts apart",
             "data": "7700: $134M (11:48) → $145M (11:51) → $154M (12:03) → $161M at 12:06, the tap bar — d15 +$28M, FRESH again by the record's window, o10 DEFLECT; then DISSIP at 12:09 (−$15M). A smaller rejection than c1 (8.5 vs 13.75) at a lower high (7701.75 vs 7704): tap decay, on the tape. No liquidity level within 5 pts.", "factors": ["king", "growth"]},
            {"leg": "c3", "kind": "PULLBACK", "side": "resistance", "when": "13:12–13:21 CT (the high 13:18)", "px": "high ES 7699.50 at 13:18 → 7687.50 by 14:03 (−12 in 15 bars), then the 13:48 flush (c4) — the third, lowest high under the King", "node": "SPXW 7700, THE KING, +γ 100% at its session peak (~$197M at 12:36) — and SPY 768 +64% (rank 3, ES 7700.7)",
             "data": "The record has no event for 7700 between 12:36 and 13:32 (a steady node fires none): at 12:36 $197M, d15 +$37M, FRESH; at 13:32 DISSIP $161M with d15 −$103M, 13:36 $119M (−$153M / 15 min) — THE KING BLED OUT RIGHT AFTER THE THIRD REJECTION and left the strike (by 13:48 the King was 7680, −γ). Three taps of a +γ King ceiling: highs 7704 → 7701.75 → 7699.50, rejections 13.75 → 8.5 → 12 pts; the ceiling held until the King itself dissolved, and the next move was the flush. No liquidity level within 5 pts.", "factors": ["king", "growth", "heavy"]},
            {"leg": "c4", "kind": "PULLBACK", "side": "support", "when": "13:45–13:57 CT (the 13:48 bar: low 7676.75, close 7688.75 — a 12-pt lower wick)", "px": "low ES 7676.75 at 13:48 → 7690.75 by 14:27 (+14 in 13 bars)", "node": "SPXW 7680, THE KING, −γ −100% (ES ~7684–7687 — AT ONL / LLO 7687.50) with the +γ 7670 (ES ~7674–7677) and SPY 765 +24% (rank 4, ES 7672.1) BENEATH it",
             "data": "The −γ King GREW INTO THE TAP: −$65M (13:39) → −$85M (13:42) → −$77M (13:48) → −$99M (13:54), TESTED → DELIVERED (2 taps) — and price went straight THROUGH it: the flush ran 10 pts past the King to the +γ 7670 (+$22M → +$30M at 13:42, d15 +$13M → +$39M at 13:51, +$15M, ACCUM, TESTED; o10 DEFLECT) and SPY 765, and the same bar closed back above the King. ONL and LLO (7687.50, the King's own price) were swept by 10.75 pts and reclaimed inside the bar. The doctrine's −γ character to the letter — wicky, violent, overshoot — with the +γ node beneath as the brake.", "factors": ["king", "growth", "liq", "heavy"]},
            {"leg": "c5", "kind": "PULLBACK", "side": "resistance", "when": "14:21–14:36 CT (the high 14:33)", "px": "high ES 7692.25 at 14:33 → 7675 by 15:03 (−17.25 in 10 bars) → the LOD", "node": "SPXW 7690, +γ 76–89% → THE KING (100%) by 14:33 (ES ~7694), stacked OVER the −γ 7685 (−40%, ES ~7689, TESTED) and the −γ 7680 (ES ~7684) — the RUG shape (+γ over −γ); SPY 767 −100% King (ES 7690.7) and 768 +60% (7700.7) in the other book; the SMA-50 at 7692.11 = the high to the tick",
             "data": "7690: $107–115M, d15 +$15M at 14:21 then flat (−1, −6M) into the tap, FRESH, 0 taps — o10 DEFLECT; 7695 +γ dissipating ($55M → $51M, d15 −$16 / −$28M); 7685 −$52M → −$56M TESTED, PIN. The high stopped 2 pts under the +γ 7690 line and ON the SMA-50. No liquidity level within 5 pts (ONL / LLO 7687.50 sits inside the −γ 7685 / 7680 zone under it). The rejection here ran to the day's low — the rug delivered.", "factors": ["king", "rug", "heavy"]},
            {"leg": "m1", "kind": "PULLBACK", "side": "resistance", "when": "08:54–08:57 CT (the bounce high 08:57)", "px": "high ES 7701.25 at 08:57 (after the 08:53 low 7688.25) → 7680.00 by 09:12 (−21.25 in 15 bars)", "node": "SPXW 7695 +γ — 80% at 08:45, THE KING (100%) by 09:03 (ES ~7699–7701) — with the −γ King 7675 (−100%, ES ~7679) thirteen below; SPY 768 −94% (ES 7700.7) and 770 −100% in the SPY book", "data": "7695: $7M at 08:39 (FRESH, +$5M/15m, role PIN) → +γ King by 09:03 → $15M at 09:12 (TESTED, 1 tap, d15 −$2M, NOTOUCH after). 7700: $50M at 09:12 growing +$52M/15m — the node that became the day's ceiling (c1) was already building above. No liquidity level within 5 pts (ONL / LLO 7687.50 is 14 below; VAL 7713.25 12 above). UNCIRCLED by him; counted on his ruling of 2026-09-09.", "factors": ["king", "growth", "fresh"], "hour": "H1", "uncircled": True},
            {"leg": "m2", "kind": "PULLBACK", "side": "support", "when": "09:03–09:12 CT (the ONL / LLO 7687.50 swept from 09:03; the low 09:12)", "px": "low ES 7680.00 at 09:12 → 7696.75 by 09:2x (+16.75); the sweep 7.5 pts through ONL / LLO, reclaimed within two bars", "node": "SPXW 7675 −γ, THE KING (−98% at 09:03, −100% at 09:12; ES ~7679–7681) — the low printed ON it; 7680 −61% → −40% beside it; the +γ 7695 King-turned-rank-1 above; SPY 766 +46% (ES 7681.7) — the +γ node in the other book AT the low", "data": "7675: −$20M at 09:12 (d15 −$6M — growing in magnitude into the tap), DECAYING → DELIVERED (2 taps at 09:15, 3 at 09:18 — the record's own o10: DEFLECT at 09:12 / 09:15 / 09:18 / 09:21 / 09:24). 7680: −$13M → −$19M (d15 −$9M). 7700 above: +$59M, +$60M/15m. Liquidity: ONL / LLO 7687.50 swept 7.5 pts (L12 — a liquidity level at a −γ King gets swept before the turn; here the low was ON the −γ King, no +γ node beneath — the SPY 766 +γ carried the turn). UNCIRCLED; counted on his ruling of 2026-09-09.", "factors": ["king", "growth", "liq", "side"], "hour": "H1", "uncircled": True},
            {"leg": "m3", "kind": "PULLBACK", "side": "support", "when": "09:30–09:33 CT (the low 09:31)", "px": "low ES 7684.50 at 09:31 (3 pts under ONL / LLO 7687.50, reclaimed the same bar) → 7692.50 by 09:42 (+8) → 7700 by 09:55 (+15.5)", "node": "SPXW 7680 −γ −47% (ES ~7684) — the low printed on it; 7675 −γ −30% (the morning's King, faded) beneath; the +γ crown 7700 / 7705 (100 / 90%) fifteen above", "data": "7680: −$36M at 09:30 → −$38M at 09:33 (d15 −$18M → −$5M), TESTED 1 tap — the record's own o10: DEFLECT at 09:33 / 09:36 / 09:39. 7675: −$23M, DELIVERED 4 taps by 09:30 (spent). 7700: $78M → $85M, +$18–20M/15m — the +γ King growing above (the target). Liquidity: ONL / LLO 7687.50 dipped 3 pts under and reclaimed. UNCIRCLED; counted on his ruling of 2026-09-09.", "factors": ["growth", "liq", "side"], "hour": "H2", "uncircled": True},
            {"leg": "m4", "kind": "PULLBACK", "side": "support", "when": "09:45–09:51 CT (the low 09:45; the break higher 09:51)", "px": "low ES 7686.75 at 09:45 → 7700.00 by 09:55 (+13.25 in 10 bars) — the rally into the 7700 / 7705 crown that became c1", "node": "SPXW 7680 −γ −42% (ES ~7684, 2.75 under the low), DELIVERED; 7695 +γ 23% (ES ~7699) just above; SPY 767 +47% rank 5 (ES 7690.5) — the +γ node in the other book at the low; the +γ King 7700 / 7705 (100 / 91–100%) growing above", "data": "7680: −$37M at 09:45 (d15 −$1M, flat) → −$37M, DELIVERED 2–3 taps — o10 DEFLECT at 09:45. 7695: $19M → $25M by 09:54 (FRESH, +$8M/15m), o10 PIN / DEFLECT. 7700: $88M → $98M → $107M (+$7–19M/15m) and 7705 $80M → $104M (+$20–28M/15m) — the crown building as price rose into it. No liquidity level within 5 pts. UNCIRCLED; counted on his ruling of 2026-09-09.", "factors": ["growth", "stack", "fresh"], "hour": "H2", "uncircled": True},
            {"leg": "c6", "kind": "LOD", "side": "support", "when": "14:54–15:00 CT (the low 14:59)", "px": "low ES 7672.25 at 14:59 — THE SESSION LOW — the 14:57 bar 7672.25 → 7681 (+8.75 in 3 bars into the close; 7681 after hours)", "node": "SPXW 7665 +γ (20% → 66%, ES ~7669–7672) with 7670 +γ (21–40%, ES ~7674–7677) — a fresh, growing +γ STACK beneath the −γ King 7680 (−100%, ES ~7684–7687 — the ONL / LLO price again); SPY 765 +26% (rank 2 by 14:57, ES 7670.7) and the SPY King 766 +100% (ES 7680.6)",
             "data": "7665: $37M (14:24, 28%, FRESH, role BRK) → $60M at 14:54 (66%, d15 +$47M) → $50M (15:00) — a node that crossed 20% at 14:24 and more than doubled into the low; 7670: $27M (14:24) → $54M at 14:51 (d15 +$30M) → $49M. The −γ King above: −$136M (14:36) → −$188M (14:48) → −$182M (14:57), DELIVERED, 3 taps — price fell through it at 14:42 (7686 → 7672 in 15 min) and turned 12–15 pts below it at the +γ stack, exactly as at 13:48 (c4). No liquidity level anywhere near 7672 — a fresh low under every level of the day; the turn was gamma alone. Not reclaimed by the close (7678.25) — the after-hours print 7681 is above the +γ stack, still under the King.", "factors": ["new", "growth", "stack", "king"]}
        ],
        "call": {"kind": "PULLBACK ×5 then LOD", "summary": "one +γ King ceiling tapped three times with decaying rejections and lower highs until the King bled out; then a −γ King under price that was NOT the floor twice — the flush ran a zone through it and turned at the growing +γ stack beneath, the second time printing the LOD; the fifth rejection at the new +γ King over the −γ pair (a rug) on the SMA-50"},
        "blind": None,
        "rules": ["L1", "L2", "L5", "L6", "L7", "L9", "L10", "L11", "L12"],
        "open": "HIS RULING 2026-09-09 on the first-hour turns: \"i agree i think you should also tag other hours\" — m1–m4 are counted as deflections, tagged by the hour (H1 / H2), and every leg in the corpus carries its hour. The panel's own `defl` ledger fired 21 rows inside his six windows and matched none — it reads ±0.50 SPY wobbles; he reads 8–17-pt turns at the top-3 lines. The tap record (R-25) is designed at his scale.",
    },
    {
        "id": "E006", "date": "2026-09-08", "chart": "NQ1 · Skylit · 3-min · Sep 8 08:30–15:00 CT, the projection on (the PDH 29693.08 · PDC 29543.50 · PDL 29424.75 lines on the chart are Sep 8's own, drawn for Sep 9). The day: H 29686.50 (08:30) · L 29424.75 (09:09) · C 29543.50. The prior session Fri Sep 4: PDH 29691.75 · PDL 29468 · PDC 29569.25 · POC 29512 · VAH 29592 · VAL 29483. ⚠ The courier's NQ rows have no overnight bars — ONH / ONL / Asia / London for NQ are not available yet (the ES courier has them). NQ = QQQ × 41.12 (±10 pts; Skylit's own ratio at the close 41.12, read off the IRT file's QQQ rows).", "tz": "CT",
        "img": "learning/deflections/img/E006.png",
        ...
        "his": "here are 4 examples from the NQ to also help you learn",
        "legs": [
            {"leg": "m1", "kind": "LOD", "side": "support", "when": "09:02–09:12 CT (the PDL 29468 swept from 09:02; THE SESSION LOW 09:11)", "px": "low NQ 29424.75 at 09:11 — THE SESSION LOW — 43 pts through the PDL 29468, reclaimed by 09:14 (29479.50) → 29580 by 09:3x (+155)", "node": "QQQ 717 −γ (−96% at 09:09, −83% at 09:12; NQ ~29483) above the low and the −γ QQQ King 714 (−100%, NQ ~29360) 65 below it — the low printed BETWEEN the two −γ nodes, 58 under 717, at the PDL sweep; +γ 721 (34–36%, NQ ~29648) and 720 far above; in the SPY book the +γ King 765 (100%) sat at ES ~7671 — the ES low of the same minute was 7680", "node_hint": "no dollar record for QQQ (E006's caveat)", "data": "QQQ has no $ in the record; by the ladder: 717 −76% (08:57) → −92% (09:06) → −96% (09:09) → −83% (09:12) → −92% (09:15) — a −γ node growing in %King into the sweep, easing on the reclaim; the King 714 held −100% throughout. Liquidity: the PDL 29468 swept 43 pts and reclaimed — the deepest sweep of the day, and the session low (L12's shape with the level BELOW the −γ node this time). UNCIRCLED by him; counted on his ruling of 2026-09-09.", "factors": ["liq", "growth", "king"], "hour": "H1", "uncircled": True},
            {"leg": "c1", "kind": "PULLBACK", "side": "resistance", "when": "08:45–09:00 CT (three bounces capped: 08:48 h 29527.75 · 08:54 h 29526.25 · 08:57 h 29538.50)", "px": "highs 29526–29538 → the LOD 29424.75 at 09:09 (−114 pts); the 09:24 retest from below (h 29524.75) BROKE THROUGH → 29640 by 12:20", "node": "QQQ 718, −γ −45% → −59% → −56%, rank 3 (NQ ~29524–29528 — the band on the chart); the QQQ King 714 −100% (29360) far below; 717 −62 → −77% (29483) between",
             "data": "718 grew −45% → −59% (08:48 → 08:51) as the first two bounces were capped, then faded −41 → −56 → −36 → −22% (09:03) as price fell away and left the top eight by 09:12; back at −16% at 09:24 when price came up through it. A −γ node as the LID on the pullbacks of the opening drive (a −γ trend day: rg 'trend', er 0.49) — L5's 'above price a lid'. Liquidity: none at 29525 (PDC 29569 above, POC 29512 thirteen below); the bounces' lows 29455–29470 sat on the VAL 29483 / PDL 29468 — the level the LOD then swept.", "factors": ["heavy", "growth"]},
            {"leg": "c2", "kind": "PULLBACK", "side": "support", "when": "11:03–12:15 CT (the hour sitting on the band; the dip 11:57: low 29549.50, close 29573.50)", "px": "low 29549.50 at 11:57 → 29629 in 2 bars (+79.75) → 29640 by 12:20", "node": "QQQ 719, THE KING, −γ −100% (NQ ~29566) = the PDC 29569.25 — King and prior close at one price; 720 +γ 48–73% (rank 2, 29606) above it",
             "data": "719 read −100% from 11:30 to 12:00 without a break (the King all hour; 720 took the crown for one bar at 11:33 and went back to 48–55%). The dip OVERSHOT the −γ King by 16 pts and the bar closed 8 pts back above it — the −γ overshoot again, on NQ's scale. Liquidity: the PDC 29569.25 at the King's price, swept by 20 pts and reclaimed in the bar.", "factors": ["king", "liq"]},
            {"leg": "c3", "kind": "PULLBACK", "side": "resistance", "when": "13:00–13:45 CT (the high 13:15; the retest 13:39)", "px": "high 29615.50 at 13:15 → 29570 (−45 in 20 bars) → the 14:xx decline to 29496", "node": "QQQ 720, +γ 20–33%, rank 2–4 (NQ ~29606) with 721 +γ 23–31% (29648) above — a +γ pair over the −γ King 719 (29566)",
             "data": "720: 32% (12:51) → 20% (13:00) → 32% (13:06) → 24% (13:12) → 20% at 13:15 — FADING into the tap by the ladder's %, and it held anyway (a weak case for L1 — or the % fell because the King grew; no $ for QQQ). 721: 26 → 31%. The high stopped 9 pts over the 720 line. Liquidity: the VAH 29592 twenty-three below the high — price closed back under the value area high after the rejection; PDH 29691 far.", "factors": ["heavy"]},
            {"leg": "c4", "kind": "PULLBACK", "side": "support", "when": "14:30–15:00 CT (the low 14:54: 29496, close 29520.75; the RTH close 29543.50)", "px": "low 29496 at 14:54 → 29543.50 at the close (+47.5 in 2 bars)", "node": "QQQ 718, −γ −37% → −88% → −100% — TOOK THE CROWN at 14:54, on the low (NQ ~29524) — over the prior day's POC 29512; 719 (the King until 14:51, −100 → −82%, 29566) above",
             "data": "718: −37% (14:30) → −41 → −47 → −48 → −40 → −56% (14:45) → −88% (14:48) → −68% → −100% at 14:54: a −γ node growing hard into the tap and becoming the King as price arrived. The flush OVERSHOT it by 28 pts (29496), swept the POC by 16, and the next bar closed back above the line. Liquidity: the prior POC 29512 twelve under the King's line.", "factors": ["king", "growth", "liq"]}
        ],
        "call": {"kind": "PULLBACK ×4", "summary": "a −γ node as the lid on the opening drive's bounces; the −γ King as a floor twice, both times overshot (16 and 28 pts) and reclaimed within a bar, both at a prior-day liquidity level (PDC, POC); a +γ pair as the afternoon ceiling. NOT circled: the LOD itself (09:09, 29424.75) — PDL 29468 swept 43 pts + VAL 29483 + the −96% 717 node at the PDL, +155 pts in 20 bars — no node band at 29424 on the chart."},
        "blind": None,
        "rules": ["L1", "L5", "L9", "L10", "L12"],
        "open": "The QQQ book has no dollar record in the panel (the node-event ledger is SPX strikes only) — the NQ examples are read from the ladder's %King; the tap record (R-25) must carry the QQQ book on NQ with dollars. The NQ LOD 09:11 at the PDL sweep is m1, counted on his ruling of 2026-09-09. The courier carries NQ's night from companion v1.19 (ONH / ONL / Asia / London on the NQ chart from v15.88).",
    }
]
...
# (v15.88) THE HOUR ON EVERY LEG — his ruling 2026-09-09: "i agree i think you should also tag other hours". Derived from the
# first HH:MM in `when` unless the leg states it; H1 08:30–09:30 … H5 12:30–13:30, H6 13:30–14:00, H7 14:00–15:00 — the same
# seven the pattern table's hour class uses (tools/nightly/patterns.py hour_classes). A leg outside RTH keeps no hour.
def hour_of(when):
    m = re.search(r'(\d{1,2}):(\d{2})', when or '')
    if not m:
        return None
    mins = int(m.group(1))*60 + int(m.group(2)) - 510
    if mins < 0 or mins >= 390:
        return None
    return 'H7' if mins >= 330 else ('H6' if mins >= 300 else 'H%d' % (mins//60 + 1))

for _e in EXAMPLES:
    for _g in _e.get("legs", []):
        if not _g.get("hour"):
            _h = hour_of(_g.get("when"))
            if _h:
                _g["hour"] = _h
...
def md():
    ...
    for e in EXAMPLES:
        ...
        L.append("")
        L.append("| leg | hour | kind | side | when | price | node | factors | what the record says |")
        L.append("|---|---|---|---|---|---|---|---|---|")
        for g in e["legs"]:
            L.append("| %s | %s | %s | %s | %s | %s | %s | %s | %s |" % (g["leg"]+(" ⚐" if g.get("uncircled") else ""), g.get("hour", "—"), g["kind"], g["side"], g["when"], g["px"], g["node"], ", ".join(g["factors"]), g["data"]))
        L.append("")
