...
subject("K", "KINGS", "the crown: which book's, what role, when it moves, and what it does to price", [
    ...
    sub("K2", "King deflections by role — floor · ceiling · pin", "SIDE · TARGET",
        [st("K2.1", "King BELOW spot (a floor): tap held rate and the bounce's extent", "SIZE · TARGET", "C10", "tap record", "OPEN"),
         ...
         st("K2.6", "The rolling floor: a King that rolled UP today and holds as a floor — does the trend resume more often than after any floor? (his read, 2026-09-04; H8, read once at n = 30 from the first stamped session)", "SIDE · TARGET", "Academy: floor rolling up = bullish", "tap record (stamped, v15.72+)", "REGISTERED"),
         st("K2.7", "The rolling ceiling: a King that rolled DOWN today and holds as a ceiling — does the trend resume more often than after any ceiling? (H9, the mirror)", "SIDE · TARGET", "Academy: ceiling rolling down = bearish", "tap record (stamped, v15.72+)", "REGISTERED")]),
