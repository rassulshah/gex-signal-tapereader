...
ok(/'⑥','SELF-TEST'/.test(src) || /'⑥','THE SUITE \\u00b7 self-test'/.test(src) || /panSection\('t5','\\u2465','THE SUITE'/.test(src), '9b ...in section ⑥ of the Testing tab (v15.62: ⑥ THE SUITE, the mockup’s section)');
