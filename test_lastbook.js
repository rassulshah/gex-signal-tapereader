...
// (v15.03) the book is now a PARAMETER — SPXW and QQQ are both latched — but the invariant is
...
// ---- (v15.03) ONE LATCH PER GOVERNING BOOK ----------------------------------------------------
...
// ---- (v15.03) AN ABSENCE THE CODE CAN EXPLAIN MUST NOT BE SHOWN AS A BLANK -------------------
...
ok(!/return B|return any/.test(SBW),
   'l18 ...and returns a REASON, never a substitute book — serving SPXW on QQQ is the bug v15.03 removed');
