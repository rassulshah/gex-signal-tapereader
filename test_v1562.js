...
ok(tabs.length===9 && /Data/.test(tabs[1]) && /Analysis/.test(tabs[2]) && /Learn/.test(tabs[4]) && /Rec/.test(tabs[5]) && doc.querySelector('#gpts-body .g3pan .tabs span.on').textContent.indexOf('Analysis')>=0,'2d the tab bar is the mockup’s .tabs: nine tabs (v15.70: Rec after Learn · v15.89: Data before Analysis), the active one .on',tabs);
