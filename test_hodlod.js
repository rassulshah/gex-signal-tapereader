...
// minute, which is exactly when the operator prepares. None of that needs a candle.
{
  ...
  // (v15.00) THREE A rows now — the excursion block, the day block, and the new SPAN row that
...
// ============================================================================================
{
  ...
  // (v15.00) LC|HC GAP·RNG moved OUT of the table and into the strip beside the read — operator:
  ...
  // (v15.00) the LC pair moved AGAIN — out of the v15.00 top strip and into ROW 3, which is where
...
// ============================================================================================
// (v15.00) SLvl / TLvl, AND THE PT LEG'S WICK FAMILY
// ============================================================================================
{
  ...
  // (v15.00) the cell now lists EVERY level taken out, furthest FIRST — he asked for names only so
