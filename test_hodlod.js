...
// minute, which is exactly when the operator prepares. None of that needs a candle.
{
  ...
  // (v14.95) THREE A rows now — the excursion block, the day block, and the new SPAN row that
...
// ============================================================================================
{
  ...
  // (v14.95) LC|HC GAP·RNG moved OUT of the table and into the strip beside the read — operator:
  ...
  // (v14.95) the LC pair moved AGAIN — out of the v14.95 top strip and into ROW 3, which is where
...
// ============================================================================================
// (v14.95) SLvl / TLvl, AND THE PT LEG'S WICK FAMILY
// ============================================================================================
{
  ...
  // (v14.95) the cell now lists EVERY level taken out, furthest FIRST — he asked for names only so
