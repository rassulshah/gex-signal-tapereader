...
// minute, which is exactly when the operator prepares. None of that needs a candle.
{
  ...
  // (v15.03) THREE A rows now — the excursion block, the day block, and the new SPAN row that
...
// ============================================================================================
{
  ...
  // (v15.03) LC|HC GAP·RNG moved OUT of the table and into the strip beside the read — operator:
  ...
  // (v15.03) the LC pair moved AGAIN — out of the v15.03 top strip and into ROW 3, which is where
...
// ============================================================================================
// (v15.03) SLvl / TLvl, AND THE PT LEG'S WICK FAMILY
// ============================================================================================
{
  ...
  // (v15.03) the cell now lists EVERY level taken out, furthest FIRST — he asked for names only so
