...
// minute, which is exactly when the operator prepares. None of that needs a candle.
{
  ...
  // (v14.94) THREE A rows now — the excursion block, the day block, and the new SPAN row that
...
// ============================================================================================
{
  ...
  // (v14.94) LC|HC GAP·RNG moved OUT of the table and into the strip beside the read — operator:
  ...
  // (v14.94) the LC pair moved AGAIN — out of the v14.94 top strip and into ROW 3, which is where
...
// ============================================================================================
// (v14.94) SLvl / TLvl, AND THE PT LEG'S WICK FAMILY
// ============================================================================================
{
  ...
  // (v14.94) the cell now lists EVERY level taken out, furthest FIRST — he asked for names only so
