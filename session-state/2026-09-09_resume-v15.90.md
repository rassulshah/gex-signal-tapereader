...
_written 2026-09-02, amended 2026-09-09 (v15.90, the learning process hardened) · panel v15.90 · companion v1.19 · supersedes every earlier resume note (the v15.89 note is kept as 2026-09-09_resume-v15.89.md)_
...
# ⚠⚠ 2026-09-09 (latest) — v15.90: THE LEARNING PROCESS, HARDENED ("yes, fix everything") + D-KING · D2..D5 IN THE IRT FILE ("we need to match atlas … FRONT")
...
**NEXT, in order:** (a) verify at the open (above); (b) his ✓ / ✗ on **R-33 / R-34 / R-35** and R-1 / R-2 / R-4 / R-5 / R-6;
(c) **v15.91 THE TAP RECORD, element 1** — the universe + the two controls per `design/TAP-RECORD.md` §2a, ASKED before
