...
_written 2026-09-02, amended 2026-09-07 (Labor Day, v15.75) · panel v15.75 · companion v1.18 · supersedes every earlier resume note_
...
# ⚠⚠ 2026-09-07 Labor Day (latest) — v15.75: THE CLOSED STATE — the dashboard stands on the last session when the market has not opened.
...
**NOT yet verified on his machine:** the CLOSED bar on his panel after the v15.75 reload (ask what the strip badge and
the bar say — expected ⏸ CLOSED · showing Fri 4 Sep at 14:58); Tuesday 09-08: the release at 08:30 with the first
live minute, then the first stamped session and the automatic close.
