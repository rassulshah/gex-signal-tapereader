...
_written 2026-09-02, amended 2026-09-09 (v15.91, the D rows by their book) · panel v15.91 · companion v1.19 · supersedes every earlier resume note (the v15.90 note is kept as 2026-09-09_resume-v15.90.md)_
...
# ⚠⚠ 2026-09-09 (latest) — v15.91: THE D ROWS BY THEIR BOOK, DEDUPED ("i'll go with your recommendation") · THE NDX BOOK ON HIS NQ CHART · THE NIGHTLY APPENDS FIRST
...
(R-33) and his ✓ / ✗ on R-34 / R-35 / R-1 / R-2 / R-4 / R-5 / R-6; (c) **v15.92 THE TAP RECORD, element 1** — asked before
...
(c) **THE TAP RECORD, element 1 (now v15.92)** — the universe + the two controls per `design/TAP-RECORD.md` §2a, ASKED before
built (104 rows WAIT on it); (d) readers for the 15 READY rows — K4.1 / K4.2 first (the King's attraction: PURPOSE §3B);
(e) Q12 on ~09-15; (f) the seasonality mockup (v15.92, after R-33).
