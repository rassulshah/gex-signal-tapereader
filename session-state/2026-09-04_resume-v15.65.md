...
_written 2026-09-02, amended 2026-09-04 (afternoon) · panel v15.65 · companion v1.18 · supersedes every earlier resume note_
...
**THE PLAN** is `roadmap/ROADMAP.md` and the 🗺 Roadmap tab (v15.59 the ⚙ Architecture + 🗺 Roadmap tabs · v15.60 📌 Open Items · v15.61 the ladder floor · v15.62 the mockups' look + 📚 Learn · v15.63 the dashboard conversation · v15.64 the second dashboard conversation + roadmap/ and archive/ recovered · v15.65 the PATTERN columns + the Kings' colours · v15.66 the deflection candidate score · v15.67 score the READ · v15.68 the TAP record). **The WHAT and the HOW are INSIDE THE APP from v15.59** (⚙ Architecture tab, rendered from `learning/plan.json` = `tools/plan-seed.py`; the seed, the file and the docs are pinned equal by `test_v1559.js`). Edit the plan in `tools/plan-seed.py`, run it, re-splice `PLAN_SEED`, update the docs.
...
# ⚠⚠ 2026-09-04 afternoon (latest) — v15.65: THE PATTERN COLUMNS, ONE PER BOOK; THE KINGS IN THEIR OWN COLOURS.
