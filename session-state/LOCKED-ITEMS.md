...
v1.19 so the NQ chart draws them too. The tap record's `liq` column (v15.91, next — the 🗄 Data tab took v15.89 and the hardening v15.90 on his word, 2026-09-09) reads them by name.
