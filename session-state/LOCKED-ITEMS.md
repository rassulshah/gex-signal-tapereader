...
v1.19 so the NQ chart draws them too. The tap record's `liq` column (v15.92, next — the 🗄 Data tab took v15.89, the hardening v15.90 and the D rows v15.91 on his word, 2026-09-09) reads them by name.
