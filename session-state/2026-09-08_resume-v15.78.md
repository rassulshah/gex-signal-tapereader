...
_written 2026-09-02, amended 2026-09-08 (v15.78) · panel v15.78 · companion v1.18 · supersedes every earlier resume note_
...
# ⚠⚠ 2026-09-08, later (latest) — v15.78: THE DAY CANDLE BESIDE THE LADDER, WITH THE SWEEP LABELS.
...
**⚠ THE INSTALLER IS AT 8.16 MB OF THE 8.39 MB CAP (104,732 of 110,000 lines).** The next build must trim the
manifest first: mockups ride in full (mockup-recommendations.png 0.45 MB, mockup-day-line.png 0.34 MB, …) — make them
ride like the renders (the two newest by version) in `build-installer.py`, or the build refuses.
