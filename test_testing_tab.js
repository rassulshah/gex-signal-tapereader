...
ok(/if\(ANALYSIS_VIEW\)\{ TESTING_VIEW=false; ARCH_VIEW=false; ROADMAP_VIEW=false; ITEMS_VIEW=false; LEARN_VIEW=false; \}/.test(src) && /if\(TESTING_VIEW\)\{ ANALYSIS_VIEW=false; ARCH_VIEW=false; ROADMAP_VIEW=false; ITEMS_VIEW=false; LEARN_VIEW=false; \}/.test(src), 'tabs mutually exclusive (v15.62: seven views) (v15.60: six views, each clears the other five)');
