...
ok(/if\(ANALYSIS_VIEW\)\{ TESTING_VIEW=false; ARCH_VIEW=false; ROADMAP_VIEW=false; ITEMS_VIEW=false; LEARN_VIEW=false; REC_VIEW=false; \}/.test(src) && /if\(TESTING_VIEW\)\{ ANALYSIS_VIEW=false; ARCH_VIEW=false; ROADMAP_VIEW=false; ITEMS_VIEW=false; LEARN_VIEW=false; REC_VIEW=false; \}/.test(src), 'tabs mutually exclusive (v15.70: eight views, each clears the other seven)');
