...
ok(/if\(ANALYSIS_VIEW\)\{ DATA_VIEW=false; TESTING_VIEW=false; ARCH_VIEW=false; ROADMAP_VIEW=false; ITEMS_VIEW=false; LEARN_VIEW=false; REC_VIEW=false; \}/.test(src) && /if\(TESTING_VIEW\)\{ DATA_VIEW=false; ANALYSIS_VIEW=false; ARCH_VIEW=false; ROADMAP_VIEW=false; ITEMS_VIEW=false; LEARN_VIEW=false; REC_VIEW=false; \}/.test(src), 'tabs mutually exclusive (v15.89: nine views, each clears the other eight)');
