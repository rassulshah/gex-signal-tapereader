...
ok(Object.keys(RJ.rules).length===71, "1d all 71 rule ids carried over (+ em.read v11.70, spx.nodes v11.84, rolllatch v13.9)", Object.keys(RJ.rules).length);
...
ok(/@version\s+14\.5/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
