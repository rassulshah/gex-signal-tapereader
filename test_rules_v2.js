...
ok(Object.keys(RJ.rules).length===69, "1d all 69 rule ids carried over (+ em.read v11.70, spx.nodes v11.84)", Object.keys(RJ.rules).length);
...
ok(/@version\s+11\.88/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
