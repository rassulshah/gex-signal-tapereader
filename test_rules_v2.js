...
ok(Object.keys(RJ.rules).length===61, '1d all 61 rule ids carried over (60 + gex.path)', Object.keys(RJ.rules).length);
...
ok(/@version\s+11\.28/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
