...
ok(Object.keys(RJ.rules).length===67, "1d all 67 rule ids carried over (+ em.read, v11.70)", Object.keys(RJ.rules).length);
...
ok(/@version\s+11\.70/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
