...
ok(Object.keys(RJ.rules).length===75, "1d all 75 rule ids carried over (+ em.read v11.70, spx.nodes v11.84, rolllatch v13.9, attract v14.7, levelstate v14.30, lodhod v14.96, farside v14.96)", Object.keys(RJ.rules).length);
...
ok(/@version\s+14.96/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
