...
ok(Object.keys(RJ.rules).length===60, '1d all 60 rule ids carried over (59 + levels)', Object.keys(RJ.rules).length);
...
ok(/@version\s+11\.20/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
