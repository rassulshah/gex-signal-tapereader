...
ok(Object.keys(RJ.rules).length===66, "1d all 66 rule ids carried over (+ em.pace, piles.netPolarity, v11.68)", Object.keys(RJ.rules).length);
...
ok(/@version\s+11\.69/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
