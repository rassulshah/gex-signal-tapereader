...
ok(Object.keys(RJ.rules).length===59, '1d all 59 rule ids carried over (58 + exp.breadth)', Object.keys(RJ.rules).length);
...
ok(/@version\s+11\.6/.test(src) && /v'\+GPTS_VERSION\+' part1 loaded/.test(src) && />v'\+GPTS_VERSION\+'<\/span>/.test(src),
