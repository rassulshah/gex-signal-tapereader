...
// ⚠⚠ COMMENTS ARE STRIPPED FIRST, AND THAT IS NOT COSMETIC (v14.93). A prose line reading
...
// marker that deliberately parks at its inner edge.
{
  ...
  // ⚠⚠ (v14.93) g5a/g5b ARE REWRITTEN, NOT DELETED. They guarded the ROLL LANE's gap between the
  ...
  // ⚠ AND THE NAME MUST TOUCH ITS PRICE. That is the whole point of v14.93: "PDC 7741" as one
...
// ⚠⚠ (v14.93) r4-r7 PINNED `ladderRolls`, WHICH IS GONE. The operator repurposed its lane:
...
// ============================================================================================
// (v14.93) THE KING MIGRATION COLUMNS
// ============================================================================================
...
// ---- (v14.93) ...AND THE KING DOES NOT CARRY ITS OWN 100% -----------------------------------
...
// ============================================================================================
// (v14.93) THE FIVE THINGS HE ASKED FOR ON 2026-08-28, EACH PINNED
// ============================================================================================
...
// ⚠⚠ v14.93 PUT THE NAMES INSIDE THE CHUTE AND HE REJECTED IT: "move the level name like PDC next
...
// across the bars. The chute's own "price's alone" invariant, which v14.93 deliberately reversed,
...
// ⚠⚠ (v14.93) x6/x7 FLIPPED FROM RIGHT-JUSTIFIED TO CENTRED, and the reason is the point: the
