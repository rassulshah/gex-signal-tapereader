...
// ⚠⚠ COMMENTS ARE STRIPPED FIRST, AND THAT IS NOT COSMETIC (v15.04). A prose line reading
...
// marker that deliberately parks at its inner edge.
{
  ...
  // ⚠⚠ (v15.04) g5a/g5b ARE REWRITTEN, NOT DELETED. They guarded the ROLL LANE's gap between the
  ...
  // ⚠ AND THE NAME MUST TOUCH ITS PRICE. That is the whole point of v15.04: "PDC 7741" as one
...
// ⚠⚠ (v15.04) r4-r7 PINNED `ladderRolls`, WHICH IS GONE. The operator repurposed its lane:
...
// ============================================================================================
// (v15.04) THE KING MIGRATION COLUMNS
// ============================================================================================
...
// ---- (v15.04) ...AND THE KING DOES NOT CARRY ITS OWN 100% -----------------------------------
...
// ============================================================================================
// (v15.04) THE FIVE THINGS HE ASKED FOR ON 2026-08-28, EACH PINNED
// ============================================================================================
...
// ⚠⚠ v15.04 PUT THE NAMES INSIDE THE CHUTE AND HE REJECTED IT: "move the level name like PDC next
...
// across the bars. The chute's own "price's alone" invariant, which v15.04 deliberately reversed,
...
// ⚠⚠ (v15.04) x6/x7 FLIPPED FROM RIGHT-JUSTIFIED TO CENTRED, and the reason is the point: the
