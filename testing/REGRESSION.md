...
|---|---|---|---|---|
| **gamma** — lsGammaProfile | `test_gammaprofile_build.js` (78 + 4 mutations; fixtures A 09:47 / B synthetic / IF 10:20 / §11 the SPY book + the Atlas pool) · `test_if_extras.js` (24: depth pill, slope word, level rows) | `test_gammaprofile_logic.cpp` (63 + 3 mutations; 0.59 `effectiveRank`) · `test_contractoffset_logic.cpp` (15: the SCALEREF-minute anchor, shared with KT) | `gamma-profile/fixtures/` fixtureA-0947 · fixtureIF-1020 · 1325 · 1426 (Gate A of the runner; the Atlas/IRT transcriptions of 1325/1426 are live-run records, not regressions) | `gamma-profile/CHECKLIST.md` |
