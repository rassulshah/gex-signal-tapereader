...
// ⚠ the loops must be LENGTH-DRIVEN, or a future step count silently truncates the bar
{
  ...
  // (v14.94) ONE section renders. TREND came off the face on his instruction — "even the dntend
  ...
  ok(/var secs=\[secLoc\]/.test(pv), 'one section renders (v14.94: TREND off the face)');
