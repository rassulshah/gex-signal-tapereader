...
// ⚠ the loops must be LENGTH-DRIVEN, or a future step count silently truncates the bar
{
  ...
  // (v15.04) ONE section renders. TREND came off the face on his instruction — "even the dntend
  ...
  ok(/var secs=\[secLoc\]/.test(pv), 'one section renders (v15.04: TREND off the face)');
