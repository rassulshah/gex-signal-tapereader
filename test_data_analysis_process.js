...
ok(TABS.every(t=>doc.includes(t)) && /🗄 \*\*Data\*\*/.test(doc) && /No tenth tab/.test(doc) && /The nine tabs/.test(doc),'d6 the nine tabs, the final set — the Data tab his (v15.89), no tenth');
