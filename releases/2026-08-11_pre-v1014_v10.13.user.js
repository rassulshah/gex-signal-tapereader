...
console.log('[GPTS] v10.13 part1 loaded');
...
function confluence(sym){
  ...
  var contribs=[
    ...
    { key:'nodes',   role:'BREADTH', dir:nodes,   w:W.nodes*(0.4+0.6*nb.mag) }
  ];
...
function render(){
  ...
  html+=confluenceStrip('SPY');  // (v10.13) integrated thesis across all 4 reads
