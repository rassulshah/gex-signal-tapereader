...
console.log('[GPTS] v10.27 part1 loaded');
...
function kingBlock(){
  ...
  function sideMagnet(node, isSup){
    ...
    if(!node){ return '<span style="display:inline-flex;flex-direction:column;align-items:center;justify-content:center;padding:4px 10px;min-height:42px;box-sizing:border-box;border-radius:16px;background:'+PAL.card+';border:1.5px solid '+PAL.line+';opacity:.6"><span style="font-size:8px;font-weight:800;line-height:1;color:'+PAL.sub+';letter-spacing:.4px">'+lbl+'</span><span style="width:100%;height:1px;background:'+PAL.line+';margin:2px 0"></span><span style="color:'+PAL.sub+';font-size:11px;line-height:1">\u2013</span></span>'; }
    ...
    return '<span title="'+tip.replace(/"/g,'')+'" style="display:inline-flex;flex-direction:column;align-items:center;justify-content:center;padding:4px 10px;min-height:42px;box-sizing:border-box;border-radius:16px;background:'+PAL.card+';border:1.5px solid '+col+'">'+
      '<span style="font-size:8px;font-weight:800;line-height:1;color:'+col+';letter-spacing:.4px">'+lbl+'</span>'+
      '<span style="width:100%;height:1px;background:'+PAL.line+';margin:2px 0"></span>'+
      '<span style="line-height:1;white-space:nowrap"><span style="font-weight:800;font-size:14px;color:'+col+';font-variant-numeric:tabular-nums">'+fmtNum(node.k)+'</span> <span style="color:'+PAL.sub+';font-size:9px;font-weight:600;font-variant-numeric:tabular-nums">'+node.pct+'%</span></span>'+
    '</span>';
  }
