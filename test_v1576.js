...
ok(/ranked\.slice\(0,4\)/.test(B) && /lbl:'XG'\+\(i\+2\)/.test(B), '1f four rows, labelled XG2..XG5 (v15.85; G2..G5 until then) — the King\'s slot is the gold line, no G1');
...
ok(/\/\^\(XG\|SG\|G\)\[2-5\]\$\/\.test/.test(ex('irtGHeld')), '1m ...and only ever returns XG2..XG5 / SG2..SG5 / G2..G5 (NQ) rows (v15.85)');
